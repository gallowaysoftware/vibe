...
plus three bonus gates; **14d PASSED the same day under
[C17](c17-gate-closure.md)**, and 14a now reaches a **real ntfy topic** —
only the phone half is still owed.
